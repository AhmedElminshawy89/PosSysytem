                              ...
                              column.visible && (
                                <th
                                  ...
                                  className={`text-nowrap ${
                                    column.label === "SL"
                                      ? "min-w-50px": column.label === "Action"?"text-end"
                                      : column.label === "Unavailable Date"?"text-start pe-0 min-w-200px"
                                  ...
                                  <td
                                    ...
                                    className={`${
                                      column.label === "SL"
                                        ...
                                        column.label === "Unavailable Date"?"text-start":
                                        column.label === "Available Time"?"text-start"
                                        : "text-center pe-0"
                                    }`}
                                  >
