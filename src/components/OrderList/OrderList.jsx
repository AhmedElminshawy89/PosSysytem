...
import { TextFiedlStyles, datePickerStyles } from "./StyleMuiField";
                  ...
                  <div className="card-body pt-0" style={{ overflowX: "auto" }}>
                    ...
                    >
                      ...
                      <tbody className="fw-semibold text-gray-600">
                        {data.map((row) => (
                          <tr key={row.sl} className="fs-5 bg-white">
                            {columns.map((column, index) => {
                              ...
                              if (column.label === "State") {
                                return (
                                  <td key={index}>
                                    {row.state === "Served" ? (
                                      <Completed text={row.state} />
                                    ) : (
                                      <Pending text={row.state} />
                                    )}
                                  </td>
                                );
                              }
                                ...
                                return (
                                  <td key={index}>
                                    <div className="action-icons">
                                      ...
                                      <Link to="/ordermanage/order/orderdetails/19" 
